...
INSERT INTO `admin_passwords` VALUES (1,1,'632f05e3a1993d0bd1995ca08532f8e612e5df70c415e30aa6d3794e3909fe2c:VMkSq1YCZKyyOqE7zrWGuKK2GLzqh4V3:3_32_2_67108864',0,1705670440);
...
INSERT INTO `admin_user` VALUES (1,'admin','admin','admin@admin.com','admin','632f05e3a1993d0bd1995ca08532f8e612e5df70c415e30aa6d3794e3909fe2c:VMkSq1YCZKyyOqE7zrWGuKK2GLzqh4V3:3_32_2_67108864','2024-01-19 13:20:40','2024-01-19 13:20:40',NULL,0,0,1,NULL,NULL,NULL,'en_US',0,NULL,NULL);
...
INSERT INTO `adminnotification_inbox` VALUES (1,4,'2024-01-19 13:20:40','Disable Notice','To improve performance, collecting statistics for the Magento Report module is disabled by default. \nYou can enable it in System Config.','',0,0);
...
INSERT INTO `catalog_category_entity` VALUES (1,3,0,'2024-01-19 13:20:39','2024-01-19 13:20:39','1',0,0,1),(2,3,1,'2024-01-19 13:20:39','2024-01-19 13:20:39','1/2',1,1,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Config Data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `core_config_data` VALUES (1,'default',0,'catalog/search/engine','elasticsearch7','2024-01-19 13:20:35'),(2,'default',0,'catalog/search/elasticsearch7_server_hostname','elasticsearch','2024-01-19 13:20:35'),(3,'default',0,'catalog/search/elasticsearch7_server_port','9200','2024-01-19 13:20:35'),(4,'default',0,'catalog/search/elasticsearch7_index_prefix','magento2','2024-01-19 13:20:35'),(5,'default',0,'catalog/search/elasticsearch7_server_timeout','15','2024-01-19 13:20:35'),(6,'default',0,'web/seo/use_rewrites','1','2024-01-19 13:20:35'),(7,'default',0,'web/unsecure/base_url','https://magento.local/','2024-01-19 13:20:36'),(8,'default',0,'general/locale/code','en_US','2024-01-19 13:20:36'),(9,'default',0,'general/locale/timezone','America/Chicago','2024-01-19 13:20:36'),(10,'default',0,'currency/options/base','USD','2024-01-19 13:20:36'),(11,'default',0,'currency/options/default','USD','2024-01-19 13:20:36'),(12,'default',0,'currency/options/allow','USD','2024-01-19 13:20:36'),(13,'default',0,'general/region/display_all','1','2024-01-19 13:20:36'),(14,'default',0,'general/region/state_required','AL,AR,AU,BG,BO,BR,BY,CA,CH,CL,CN,CO,CZ,DK,EC,EE,ES,GR,GY,HR,IN,IS,IT,LT,LV,MX,PE,PL,PT,PY,RO,SE,SR,US,UY,VE','2024-01-19 13:20:37'),(15,'default',0,'catalog/category/root_id','2','2024-01-19 13:20:39'),(16,'default',0,'analytics/subscription/enabled','1','2024-01-19 13:20:40'),(17,'default',0,'crontab/default/jobs/analytics_subscribe/schedule/cron_expr','0 * * * *','2024-01-19 13:20:40'),(18,'default',0,'crontab/default/jobs/analytics_collect_data/schedule/cron_expr','00 02 * * *','2024-01-19 13:20:40'),(19,'default',0,'msp_securitysuite_recaptcha/frontend/enabled','0','2024-01-19 13:20:40'),(20,'default',0,'msp_securitysuite_recaptcha/backend/enabled','0','2024-01-19 13:20:40'),(21,'default',0,'twofactorauth/duo/application_key','mrGS2IpdnmnafaT8WFTVNYdLo82s5M4NAFBY5oLnaufcqW13EesXLVvg2zqgWmhF','2024-01-19 13:20:40');
...
INSERT INTO `flag` VALUES (1,'analytics_link_attempts_reverse_counter',0,'24','2024-01-19 13:20:40');
...
INSERT INTO `indexer_state` VALUES (1,'design_config_grid','valid','2024-01-19 13:20:40','d814329b4f8c9d4aa40632452b8c41d5'),(2,'customer_grid','valid','2024-01-19 13:20:40','bcb3a397d3faeaf2b27823ff995ee45d'),(3,'catalog_category_product','invalid','2024-01-19 13:20:38','a23b628ac8c609b37d7476dc00514c9f'),(4,'catalog_product_category','invalid','2024-01-19 13:20:38','7238be941238344857810d1058213552'),(5,'catalogrule_rule','invalid','2024-01-19 13:20:38','76f2fd767a5b7564052f3d9bcfd0a09d'),(6,'catalog_product_attribute','invalid','2024-01-19 13:20:38','194b730327b19e6d4b946a9f2cda9bea'),(7,'cataloginventory_stock','invalid','2024-01-19 13:20:38','f14344441afdff2c61706fe1d4f8d585'),(8,'inventory','invalid','2024-01-19 13:20:38','fbd63df3c75c3e9f83df3e8cd2063628'),(9,'catalogrule_product','invalid','2024-01-19 13:20:38','7ce7495763e521fa3dfff88e95899329'),(10,'catalog_product_price','invalid','2024-01-19 13:20:38','9238040cc872003c61773328faea9a44'),(11,'catalogsearch_fulltext','invalid','2024-01-19 13:20:38','fa0ba7a2b49d3b19e026a6241d9e96fe');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='View State';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=184 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='List of data/schema patches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `queue_poison_pill` VALUES ('version-65aa77244daa9');
...
INSERT INTO `theme` VALUES (1,NULL,'Magento/blank','Magento Blank','preview_image_65aa7726052d7.jpeg',0,'frontend',0,'Magento/blank'),(2,NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend'),(3,1,'Magento/luma','Magento Luma','preview_image_65aa77260def5.jpeg',0,'frontend',0,'Magento/luma');
...
-- Dump completed on 2024-01-19 13:59:07
